...
- **Does not work well on the beta client**. The sys-wine runner I recommend doesn't work at all, and the default soda runner runs at around 30FPS with severe stuttering.
